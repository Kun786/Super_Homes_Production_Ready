...
<head>
  ...
  <style>
    .parallex {
      ...
      align-items: center;
      background-image: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url('imgs/bg\ \(16\).jpg');
...
<body>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item active" href="rentCommercials.php">Commercial</a>
            </div>
          </li>
          <li class="nav-item">
  ...
  <div class="parallex">
    <h2 class="text-light">Rent Commercial</h2>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=1 and purpose='Rent' and type = 'Commercial' ORDER BY Id DESC";
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=2 and Purpose='Rent' and type = 'Commercial' ORDER BY Id DESC";
      $run = $conn->query($query);
      while ($data = mysqli_fetch_array($run)) {
        $id = $data['id'];
        $images = $data['img'];
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=0 and Purpose='Rent' and type = 'Commercial' ORDER BY Id DESC";
      $run = $conn->query($query);
      while ($data = mysqli_fetch_array($run)) {
        $id = $data['id'];
        $images = $data['img'];
