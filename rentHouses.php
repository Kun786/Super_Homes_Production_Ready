...
<head>
  ...
  <style>
    .parallex {
      ...
      align-items: center;
      background-image: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url('imgs/bg\ \(4\).jpg');
...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item active" href="rentHouses.php">House</a>
              <div class="dropdown-divider"></div>
  ...
  <div class="parallex">
    <h2 class="text-light">Rental Houses</h2>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      $query = "SELECT * FROM ads WHERE
             status=1 and purpose='Rent' and type = 'Full House'
              or status=1 and purpose='Rent' and type = 'Upper Portion'
              or status=1 and purpose='Rent' and type = 'Lower Portion' ORDER BY Id DESC";
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE
            status=2 and purpose='Rent' and type = 'Full House'
             or status=2 and purpose='Rent' and type = 'Upper Portion'
             or status=2 and purpose='Rent' and type = 'Lower Portion' ORDER BY Id DESC";
      $run = $conn->query($query);
      while ($data = mysqli_fetch_array($run)) {
        $id = $data['id'];
        $images = $data['img'];
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE
            status=0 and purpose='Rent' and type = 'Full House'
             or status=0 and purpose='Rent' and type = 'Upper Portion'
             or status=0 and purpose='Rent' and type = 'Lower Portion' ORDER BY Id DESC";
      $run = $conn->query($query);
      while ($data = mysqli_fetch_array($run)) {
        $id = $data['id'];
        $images = $data['img'];
