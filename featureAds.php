      ...
      <div class="row">
        ...
        >
          <div class="sidebar-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="#" onclick="feature()">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm table-bordered">
            ...
            <tbody>
              <?php
              $checkAdsQuery = "SELECT * FROM ads WHERE feature = '1'";
              $runCheckAdsQuery = $conn->query($checkAdsQuery);
              $totalHotAds = mysqli_num_rows($runCheckAdsQuery);
              if ($totalHotAds < 1) {
                echo "<tr><td colspan='10'><h3 class='text-center'>No feature ads yet!</h3></td></tr>";
              } else {
                ...
                while ($result = mysqli_fetch_array($run)) {
                  ...
                  echo "<td><a href='cancelFeature.php?id=$id'>" . $ft . "</td>";
