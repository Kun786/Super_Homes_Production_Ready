...
<head>
  ...
  <style>
    .parallex {
      ...
      align-items: center;
      background-image: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url('imgs/bg\ \(13\).jpg');
...
<body>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item active" href="saleCommercial.php">Commercial</a>
            </div>
          </li>
  ...
  <div class="parallex">
    <h2 class="text-light">Sales Commercial</h2>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=1 and purpose='Sale' and type ='Commercial Building' ORDER BY Id DESC";
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=2 and purpose='Sale' and type = 'Commercial Building' ORDER BY Id DESC";
      $run = $conn->query($query);
      while ($data = mysqli_fetch_array($run)) {
        $id = $data['id'];
        $images = $data['img'];
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=0 and purpose='Sale' and type = 'Commercial Building' ORDER BY Id DESC";
      $run = $conn->query($query);
      while ($data = mysqli_fetch_array($run)) {
        $id = $data['id'];
        $images = $data['img'];
