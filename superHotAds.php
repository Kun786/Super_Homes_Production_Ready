      ...
      <div class="row">
        ...
        >
          <div class="sidebar-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="#" onclick="super()">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm table-bordered">
            ...
            <tbody>
              <?php
              $checkAdsQuery = "SELECT * FROM ads WHERE status = '1'";
              $runCheckAdsQuery = $conn->query($checkAdsQuery);
              $totalHotAds = mysqli_num_rows($runCheckAdsQuery);
              if($totalHotAds<1){
                echo "<tr><td colspan='10'><h3 class='text-center'>0 superhot ads yet!</h3></td></tr>";
              }else{
                ...
                while ($result = mysqli_fetch_array($run)) {
                  ...
                  echo "<td><a href='cancelAction.php?id=$id'>" . $st1 . "</td>";
