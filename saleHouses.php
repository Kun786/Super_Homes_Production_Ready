...
<head>
  ...
  <style>
    .parallex {
      ...
      align-items: center;
      background-image: linear-gradient(rgba(0, 0, 0, .6), rgba(0, 0, 0, .6)), url('imgs/bg\ \(5\).jpg');
...
<body>
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item active" href="saleHouses.php">House</a>
  ...
  <div class="parallex">
    <h2 class="text-light">Sales Houses</h2>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=1 and purpose='Sale' and type = 'House' ORDER BY Id DESC";
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=2 and Purpose='Sale' and type = 'House' ORDER BY Id DESC";
      $run = $conn->query($query);
      while ($data = mysqli_fetch_array($run)) {
        $id = $data['id'];
        $images = $data['img'];
    ...
    <div class="row">
      <?php
      $query = "SELECT * FROM ads WHERE status=0 and Purpose='Sale' and type = 'House' ORDER BY Id DESC";
      $run = $conn->query($query);
      while ($data = mysqli_fetch_array($run)) {
        $id = $data['id'];
        $images = $data['img'];
