      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="sidebar-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="#" onclick="hot()">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-sm table-bordered">
            ...
            <tbody>
              <?php
              $checkAdsQuery = "SELECT * FROM ads WHERE status = '2'";
              $runCheckAdsQuery = $conn->query($checkAdsQuery);
              $totalHotAds = mysqli_num_rows($runCheckAdsQuery);
              if($totalHotAds<1){
                echo "<tr><td colspan='10'><h3 class='text-center'>0 hot ads yet!</h3></td></tr>";
              }else{
                $query = "SELECT * FROM ads WHERE status='2' ORDER BY Id DESC";
                ...
                while ($result = mysqli_fetch_array($run)) {
                  ...
                  echo "<td><a href='cancelAction.php?id=$id'>" . $st2 . "</td>";
